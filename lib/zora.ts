...
//
// CURRENT MODE: Static mock data (backend not yet connected)
//
// When your backend friend's Rust/Aomi tools are ready:
//   1. Delete the STATIC_* exports (or keep for fallback)
//   2. Uncomment the real API functions below
//   3. Replace calls in dashboard components accordingly
// ================================================================
...
export const STATIC_COLLECTORS: Collector[] = [
  { rank: 1, wallet: "0x8a...4b29", coinsHeld: 5, firstPurchase: "Jan 12, 2024", totalSpentETH: 12.4, badge: "WHALE" },
  { rank: 2, wallet: "0x1f...9c0e", coinsHeld: 4, firstPurchase: "Feb 3, 2024",  totalSpentETH: 8.1,  badge: "WHALE" },
  { rank: 3, wallet: "0xd4...7a11", coinsHeld: 3, firstPurchase: "Feb 28, 2024", totalSpentETH: 4.5,  badge: "FAN"   },
  { rank: 4, wallet: "0x3b...2f88", coinsHeld: 2, firstPurchase: "Mar 14, 2024", totalSpentETH: 2.8,  badge: "FAN"   },
  { rank: 5, wallet: "0x7e...1d44", coinsHeld: 1, firstPurchase: "Apr 2, 2024",  totalSpentETH: 1.2,  badge: "FAN"   },
  { rank: 6, wallet: "0xc9...33f1", coinsHeld: 1, firstPurchase: "May 10, 2024", totalSpentETH: 0.8,  badge: "NEW"   },
  { rank: 7, wallet: "0xa2...8b20", coinsHeld: 1, firstPurchase: "May 18, 2024", totalSpentETH: 0.5,  badge: "NEW"   },
  { rank: 8, wallet: "0xf0...91de", coinsHeld: 1, firstPurchase: "Jun 1, 2024",  totalSpentETH: 0.3,  badge: "NEW"   },
];

export const STATIC_COLLECTIONS: Collection[] = [
  { id: "1", name: "Genesis Wave",    priceETH: 0.08, volumeETH: 18.2, holders: 342, thumbnail: null },
  { id: "2", name: "Wave #2",         priceETH: 0.05, volumeETH: 12.4, holders: 228, thumbnail: null },
  { id: "3", name: "Wave #3",         priceETH: 0.12, volumeETH: 9.6,  holders: 189, thumbnail: null },
  { id: "4", name: "Collector Pass",  priceETH: 0.20, volumeETH: 4.1,  holders: 87,  thumbnail: null },
  { id: "5", name: "Limited Edition", priceETH: 0.35, volumeETH: 1.1,  holders: 46,  thumbnail: null },
  { id: "6", name: "Open Edition",    priceETH: 0.01, volumeETH: 0.4,  holders: 308, thumbnail: null },
];

// ================================================================
// REAL API CALLS — Uncomment when Aomi/Zora backend is ready
// ================================================================
